...
const FromSet = ({ fromUserSelected, handleFromUserSelection, userOptions, handleFromUserAcctSelection, fromUserAcctSelected, fromUserAccts, handleFromAmountChange }) => {
  return (
